...
class ProductResource(Resource):
    ...
    def patch(self, id):
        ...
        qry.stock = args['promo']
        qry.stock = args['discount']
...
class ProductList(Resource):
    def get(self):
        ...
        if args['color'] is not None:
            qry = qry.filter_by(color=args['color'])
    ...
    def get(self):  # mengambil data semua produk, filter by category dan subcategory
        ...
        if args['keyword'] is not None:
            product = Products.query.filter(Products.name.like("%"+args['keyword']+"%") |
                                            Products.ProductTypes.name.like("%"+args['keyword']+"%") |
                                            Products.size.like("%"+args['keyword']+"%")) | Products.color.like("%"+args['keyword']+"%")
